...
| PhenixID | PhenixID Authentication Services | Unknown | Fix | Temporary mitigation / workaround suggested. | [source](https://support.phenixid.se/uncategorized/log4j-fix/) | 
| PhenixID | PhenixID Identity Manager | Unknown | Fix | Temporary mitigation / workaround suggested. | [source](https://support.phenixid.se/uncategorized/log4j-fix/) | 
| PhenixID | PhenixID MFA | Unknown | Fix | Temporary mitigation / workaround suggested. | [source](https://support.phenixid.se/uncategorized/log4j-fix/) | 
| PhenixID | PhenixID Password Self Service | Unknown | Fix | Temporary mitigation / workaround suggested. | [source](https://support.phenixid.se/uncategorized/log4j-fix/) | 
| PhenixID | PhenixID Signing Service | Unknown | Fix | Temporary mitigation / workaround suggested. | [source](https://support.phenixid.se/uncategorized/log4j-fix/) | 
| PhenixID | PhenixID Signing Workflow | Unknown | Fix | Temporary mitigation / workaround suggested. | [source](https://support.phenixid.se/uncategorized/log4j-fix/) | 
